...
require (
	...
	github.com/flashbots/mev-boost-relay v1.0.0-alpha2
...
require (
	...
	github.com/attestantio/go-builder-client v0.2.7 // indirect
	github.com/attestantio/go-eth2-client v0.15.8-0.20230310152300-bc14358487b6 // indirect
